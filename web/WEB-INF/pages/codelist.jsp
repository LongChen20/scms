    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="row placeholders">
                <div class="col-md-4">
                    <form action="${pageContext.request.contextPath }/code/fandKeyCode" method="post">
                        <div class="input-group">
                            <input type="text" class="form-control" name="findkey" id="findkey" placeholder="按关键词查找">
                            <span class="input-group-btn">
			        <button class="btn btn-default" id="submit-key" type="submit"><span
            ...
            <div class="table-responsive">
                ...
                <nav aria-label="Page navigation" class="text-right">
                    ...
                    <f:page url="${pageContext.request.contextPath }/code/fandKeyCode" bean="codes"/>
